...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs__ = __webpack_require__(160);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rxjs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_rxjs__);


var getText=()=>{
__WEBPACK_IMPORTED_MODULE_0_rxjs__["Observable"].fromPromise(fetch('name.txt')
.then((res)=>res.text())
).subscribe((data)=>{
...
var getJson=()=>
{ 
  __WEBPACK_IMPORTED_MODULE_0_rxjs__["Observable"].fromPromise(fetch('readme.json')
  .then((res)=>res.json())
  ).subscribe((data)=>{
...
var getOnline=()=>
{
  __WEBPACK_IMPORTED_MODULE_0_rxjs__["Observable"].fromPromise(fetch('http://cricapi.com/api/matches/imNHt1HFajUpwOsrBUn4Ie4YKt62')
  .then((res)=>res.json())
  ).subscribe((data)=>{
